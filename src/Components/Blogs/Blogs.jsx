        ...
        <div className='relative overflow-hidden'>
            ...
            <div className='absolute w-full  top-1/4 lg:top-1/2'>
                <div className={`${width >= 1024 & width <= 1300 ? 'max-w-4xl ml-auto' : width > 1300 ? 'max-w-6xl mx-auto' : 'max-w-4xl'}  flex flex-col lg:flex-row items-center   relative`}>
                    <motion.div initial={{x:'-200px'}} animate={{x:0}} transition={{duration:.5}} className={`${width >= 1024 & width <= 1300 ? 'max-w-xl -left-28' : width > 1300 ? 'max-w-2xl' : 'max-w-xl'}  lg:absolute z-20   overflow-hidden `}>
                    ...
                    <motion.div initial={{x:'200px'}} animate={{x:0}} transition={{duration:.5}} className='lg:absolute  lg:flex justify-end z-10 lg:px-5 -right-0'>
                        <img className='hidden lg:flex w-10/12 mx-auto lg:mx-0' src={banner} alt="" />
                    </motion.div>
